...
\\*звездочки, а не курсив\\\* - отображаются спецсимволы звездочки

При обычном обрамлении звездочками, текст отображается в виде курсива.
...
Затем, в любом месте документа (предпочтительней сразу после абзаца или вместе с другими ссылками в конце документа) можно указать URL, связав его с идентификатором, например:
...
Написанное выше - только введение в возможности формата Markdown. В этом описании только то, что используется наиболее часто. Однако, с помощью Markdown можно достичь значительно более впечатляющих результатов (особенно, если знать основы HTML). 

Ознакомиться с дополнительными возможностями Markdown можно перейдя по этой [ссылке](http://lib.urfu.ru/help.php?file=advanced_markdown.html "дополнительные возможности Markdown")
...
## Отмена изменений. Удаление. Восстановление.
...
git restore *- удаляет проиндексированные, но не закоммиченные изменения*
